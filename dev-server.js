    ...
    if (action === 'analyse') {
      ...
      if (DEMO_MODE) {
        ...
        const demoData = {
          ...
          authority: 'NParks',
          legend: { removeColour: 'yellow', retainColour: 'green', transplantColour: null,
            notes: 'Green font = tree to be retained; yellow font = tree to be removed' },
          sheets: [
            { sheetNo: '0014', removeCount: 1, retainCount: 3 },
            { sheetNo: '0015', removeCount: 3, retainCount: 0 },
            { sheetNo: '0016', removeCount: 2, retainCount: 1 },
            { sheetNo: '0017', removeCount: 1, retainCount: 1 },
          ],
          // status = drawing row colour (green retain / yellow remove); independent of girth.
          trees: [
            { no: 'E0001', girth: 0.3, height: 4.0, species: 'Indian Mango', sheet: '0014', type: 'tree', status: 'remove', flags: [] },
            { no: 'E0002', girth: 0.6, height: 5.5, species: 'Angsana', sheet: '0014', type: 'tree', status: 'retain', flags: ['high_conservation'] },
            { no: 'E0003', girth: 1.2, height: 8.0, species: 'Tembusu', sheet: '0014', type: 'tree', status: 'retain', flags: ['protected', 'high_conservation'] },
            { no: 'E0004', girth: 2.5, height: 12.0, species: 'Senegal Mahogany', sheet: '0014', type: 'tree', status: 'retain', flags: ['protected', 'high_conservation', 'heritage_candidate'] },
            { no: 'E0005', girth: 0.4, height: 3.5, species: 'Mango', sheet: '0015', type: 'tree', status: 'remove', flags: [] },
            { no: 'E0006', girth: 1.8, height: 10.0, species: 'African Tulip Tree', sheet: '0015', type: 'tree', status: 'remove', flags: ['invasive', 'protected'] },
            { no: 'E0007', girth: 0.5, height: 4.2, species: 'Rambutan', sheet: '0015', type: 'tree', status: 'remove', flags: [] },
            { no: 'E0008', girth: 0.9, height: 6.8, species: 'Mango', sheet: '0016', type: 'tree', status: 'remove', flags: [] },
            { no: 'E0009', girth: 3.2, height: 18.0, species: 'Rain Tree', sheet: '0016', type: 'tree', status: 'retain', flags: ['high_conservation', 'heritage_candidate'] },
            { no: 'E0010', girth: 0.2, height: 2.5, species: 'Sea Hibiscus', sheet: '0017', type: 'shrub', status: 'remove', flags: [] },
            { no: 'E0011', girth: 1.5, height: 9.0, species: 'Angsana', sheet: '0017', type: 'tree', status: 'retain', flags: ['protected', 'high_conservation'] },
            { no: 'E0012', girth: null, height: 7.0, species: 'Unknown', sheet: '0017', type: 'tree', status: 'unknown', flags: ['missing_data'] },
          ],
          dataIssues: [
            'Tree E0012: Missing girth measurement; row colour ambiguous (status unknown)',
            'Cluster of 3 trees at location E0009: Recorded as single entry',
          ],
          totals: { remove: 6, retain: 5, transplant: 0, removeTrees: 5, removeShrubs: 1, retainTrees: 5, retainShrubs: 0 },
          totalRemove: 6,
          totalRetain: 5,
        };
